...
//     // Use useLayoutEffect to modify headerRight dynamically
//     useLayoutEffect(() => {
//       navigation.setOptions({
//         headerRight: () => (
//           <TouchableOpacity 
//             style={{ paddingHorizontal: 40, paddingVertical: 20, paddingLeft: 280, zIndex: 9999 }}
//             onPress={handleDownload}
//           >
//             <Text style={{ fontSize: 16, color: '#58a8f9' }}>Download</Text>
//           </TouchableOpacity>
//         ),
//       });
//     }, [navigation]); // Ensure this runs when the navigation object changes
...
// <TouchableOpacity style={{paddingHorizontal:40,paddingVertical:20,paddingLeft:280,position:'absolute',zIndex:9999,pointerEvents:'auto'}}>
// <Text style={{fontSize:16,backgroundColor:'transparent',color:'#58a8f9',}}>Download</Text>
// </TouchableOpacity>
