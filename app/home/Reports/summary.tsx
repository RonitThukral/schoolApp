...
export default function Summary() {
  ...
  const totalStudents = dataStudents.reduce((sum, item) => sum + item.population, 0);
        ...
        <View style={styles.card}>
          ...
          <PieChart
            ...
            <View style={styles.centerText}>
              <Text style={styles.totalText}>{totalStudents}</Text>
            </View>
          </View>
          <View style={styles.legend}>
            <View style={styles.legendItem}>
              ...
              <Text style={styles.legendValue}>4</Text>
            </View>
            <View style={styles.legendItem}>
