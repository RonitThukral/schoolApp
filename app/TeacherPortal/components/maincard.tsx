...
const data = [
  [
    { title: "My Profile", icon: require("../../../assets/images/images/women.png"), linking: "./home/profile" },
    { title: "Classes", icon: require("../../../assets/images/images/classdesk.png"), linking: "./home/classes" },
    ...
    { title: "SMS", icon: require("../../../assets/images/images/jj.png"), linking: "./home/message/messageStudent" },
    { title: "Settings", icon: require("../../../assets/images/images/setting.png"), linking: "./home/settings" },
  ],
];

const Slider = ({teacher}) => {
  const router = useRouter();
// console.log(teacher, 'stuetnjtkeakds')
  const handlePress = (link) => {
    router.push({
        pathname: link,
        params: { teacher: JSON.stringify(teacher) },  // Use 'params' here instead of 'query'
      });
  };
      ...
      <View style={{ width: "80%", height: "85%" }}>
        <Image
          ...
          style={[
            ...
            item.title === "Payrow" && styles.icon4,
