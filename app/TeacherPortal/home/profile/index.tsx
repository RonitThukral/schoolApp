            ...
            >
              <View style={styles.profileSection}>
                ...
                <View style={styles.profileInfo}>
                  <Text style={styles.studentId}>{staff?.userID || 'N/A'}</Text>
...
<ScrollView contentContainerStyle={{paddingBottom:40}}>
            ...
            >
              <InfoRow label="Position" value={staff.role} />
              <InfoRow
                label="Qualification"
                value={staff.qualifications || 'N/A'}
              />
              <InfoRow label="Department" value={staff.department || 'N/A'} />
              <InfoRow label="Campus" value={staff.campusID || 'N/A'} />
              <InfoRow label="Bank" value={staff.bank || 'N/A'} />
              <InfoRow
                label="Account No."
                value={staff.accountNumber || 'N/A'}
              />
              <InfoRow
                label="Joining Date"
                value={staff.employmentDate || 'N/A'}
              />
            </Section>
            ...
            >
              <InfoRow label="Telephone No." value={staff.telephone} />
              <InfoRow label="Mobile No." value={staff.mobilenumber} />
              <InfoRow label="Residence" value={staff.physicalAddress} />
              <InfoRow
                label="Postal Address"
                value={staff.postalAddress}
                isMultiLine
              />
            </Section>
            ...
            >
              <InfoRow
                ...
                value={`${staff?.nextofKin?.name || ''} ${
                  staff?.nextofKin?.lastname || ''
                }`}
              />
              <InfoRow
                label="Relationship"
                value={staff?.nextofKin?.relationship}
              />
              <InfoRow label="Occupation" value={staff?.nextofKin?.occupation} />
              <InfoRow label="Contact" value={staff?.nextofKin?.contact} />
              <InfoRow label="Email" value={staff?.nextofKin?.email} />
              <InfoRow
                label="Address"
                value={staff?.nextofKin?.address}
                isMultiLine
              />
            </Section>
            </ScrollView>
