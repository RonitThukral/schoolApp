...
<Stack.Screen name='test/index' options={{title: 'test',headerStyle:{backgroundColor:'transparent'}, headerTransparent:true}}/>
    ...
    <Stack.Screen name='home/Finance/feeDetails/index' options={{title: 'Fee Details',headerStyle:{backgroundColor:'transparent'}, headerTransparent:true}}/>
    ...
    <Stack.Screen name='staffDetails/index' options={{title: 'Staff Details',headerStyle:{backgroundColor:'transparent'}, headerTransparent:true}}/>
