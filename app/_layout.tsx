...
const _layout = () => {
  return (
    ...
    <Stack>
      ...
      <Stack.Screen name='home/Inventory/saleReceipt' options={{ title: 'Sales Receipt', headerStyle: { backgroundColor: 'transparent' }, headerTransparent: true }} />
      ...
      <Stack.Screen name='home/Finance/feePayment/paymentPage/index' options={{ title: 'Payment Page', headerStyle: { backgroundColor: 'transparent' }, headerTransparent: true }} />
      ...
      <Stack.Screen name='home/Reports/billPaymentReport/index' options={{ title: 'Fee Payment Report', headerStyle: { backgroundColor: 'transparent' }, headerTransparent: true }} />
    ...
    //Students Portal
      ...
      <Stack.Screen name='StudentPortal/home/finance/index' options={{
        title: 'Fees', headerStyle: { backgroundColor: '#58a8f9' }, headerTransparent: true, headerTintColor: "#fff", //  Changes back arrow color to white
